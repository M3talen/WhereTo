            ...
            switch (Provider)
            {
                case "Google":
                {
                    auth = new OAuth2Authenticator(
                        ...
                        "30003352024-c7ctdilp94j280do0rkhs2eugmfqiomd.apps.googleusercontent.com",
                        "ClientSecret",
                ...
                {
                    auth = new OAuth2Authenticator(
                        clientId: "286388638478554",  // For Facebook login, for configure refer https://code.msdn.microsoft.com/Register-Identity-Provider-41955544 
                        scope: "",
